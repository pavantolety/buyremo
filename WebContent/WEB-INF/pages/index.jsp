					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1>BuyRemo</h1>
									<h2>Aspiring for something?</h2>
									<button type="button" class="btn btn-default get">Go for It</button>
								</div>
								<div class="col-sm-6">
							...
							<div class="item">
								<div class="col-sm-6">
									<h1>BuyRemo</h1>
									<h2>Request your aspiration from people you count!</h2>
									<button type="button" class="btn btn-default get">Request Now!</button>
								</div>
								<div class="col-sm-6">
									<img src="images/home/kids1.jpg" class="girl img-responsive" alt="" />
									<!-- <img src="images/home/pricing.png"  class="pricing" alt="" /> -->
								</div>
							</div>
							...
							<div class="item">
								<div class="col-sm-6">
									<h1>BuyRemo</h1>
									<h2>Entirely New way of E-Commerce!</h2>
									<button type="button" class="btn btn-default get">Register Now!</button>
								</div>
								<div class="col-sm-6">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							<div class="panel panel-default">
								...
								<div id="sportswear" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<li><a href="#" id="nike" name="nike">Nike </a></li>
											<li><a href="#" id="adidas" name="adidas">Adidas </a></li>
											<li><a href="#" id="puma" name="puma">Puma</a></li>
											<li><a href="#" id="asics" name="asics">ASICS </a></li>
										</ul>
									</div>
								</div>
							</div>
							<div class="panel panel-default">
								...
								<div id="mens" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<li><a href="#" id="fashion" name="fashion">Guess</a></li>
											<li><a href="#" id="valentino" name="valentino">Valentino</a></li>
											<li><a href="#" id="dior" name="dior">Dior</a></li>
											<li><a href="#" id="versace" name="versace">Versace</a></li>
											<li><a href="#" id="armani" name="armani">Armani</a></li>
											<li><a href="#" id="fashion" name="fashion">Gucci</a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel panel-default">
								...
								<div id="womens" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<li><a href="#" id="fendi" name="fendi">Fendi</a></li>
											<li><a href="#" id="guess" name="guess">Guess</a></li>
											<li><a href="#" id="valentino" name="valentino">Valentino</a></li>
											<li><a href="#" id="dior" name="dior">Dior</a></li>
											<li><a href="#" id="versace" name="versace">Versace</a></li>
										</ul>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#" id="fashion" name="fashion">Kids</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#" id="fashion" name="fashion">Fashion</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#" id="households" name="households">Households</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#" id="interiors" name="interiors">Interiors</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#" id="clothing" name="clothing">Clothing</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#" id="bags" name="bags">Bags</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#" id="shoes" name="shoes">Shoes</a></h4>
								</div>
							</div>
