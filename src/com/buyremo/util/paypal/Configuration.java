...
public class Configuration {
	...
	public static final Map<String,String> getAcctAndConfig(){
		...
		// Account Credential
		configMap.put("acct1.UserName", SystemParams.PAYPAL_USERNAME);
		configMap.put("acct1.Password", SystemParams.PAYPAL_PASSWORD);
		configMap.put("acct1.Signature", SystemParams.PAYPAL_SIGNATURE);
	    configMap.put("acct1.AppId", SystemParams.PAYPAL_APP_ID);
	...
	public static final Map<String,String> getConfig(){
		...
		configMap.put("mode", SystemParams.PAYPAL_MODE);
